function OscuroClaro(){
    ...
    document.getElementById("d-habilidades").classList.toggle("text-black")
    document.getElementById("b-progress").classList.toggle("progress2")
    document.getElementById("b-progress2").classList.toggle("progress2")
    document.getElementById("b-progress3").classList.toggle("progress2")
